...
def run_stage5_parallel(
    python_executable: PathArg,
    project_root: PathArg,
    config_path: PathArg = "configs/stage5_sensitivity.yaml",
    *,
    profile: str = "smoke",
    frozen_tuning: PathArg = "results/stage5/tuning/frozen-fast.json",
    cache_root: PathArg = "results/stage5/smoke/cache",
    output_root: PathArg = "results/stage5/smoke/raw",
    log_dir: PathArg = "results/stage5/smoke/log",
    cpu_workers: int = 5,
    ensemble_workers: int = 2,
    retry_failed: bool = False,
    dry_run: bool = False,
